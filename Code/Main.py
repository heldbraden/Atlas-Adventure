...
restartBtn = Button(screenWidth // 2, screenHeight // 2, restart)
startBtn = Button(screenWidth // 2, screenHeight // 2, start)
...
while run:
    ...
    if mainMenu == True:
        ...
        if gameOver == -1:
            if restartBtn.draw():
                player.reset(350, 200)
                world1.reset(world1_level1)
                world1.draw()
                gameOver = 0
